class Vacation {
    ...
    removeChild(name, grade) {
        ...
        if (this.kids.hasOwnProperty(grade)) {
            ...
            for (const kid of this.kids[grade]) {
                ...
                if (kidName === name) {
                    let indexOfTheKid = this.kids[grade].indexOf(kid);
                    this.kids[grade].splice(indexOfTheKid, 1);
                    return this.kids[grade];
                }
            }
        }
    ...
    get numberOfChildern() {
        ...
        // Object.entries(this.kids).sort((a, b) => a.grade - b.grade);
