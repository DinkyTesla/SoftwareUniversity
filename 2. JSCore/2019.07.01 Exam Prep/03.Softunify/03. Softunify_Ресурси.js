...
describe("Softunify", () => {
    ...
    it("Are all songs Objects", () => {
        let myClass = new SoftUniFy();
        assert.deepEqual(myClass.allSongs, {});
    });

    // it("Is download song OK?", () => {
    //     let myClass = new SoftUniFy();
    //     myClass.downloadSong('Eminem', 'Venom', 'Knock, Knock let the devil in...');
    //     myClass.downloadSong('Eminem', 'Phenomenal', 'IM PHENOMENAL...');
    //     myClass.downloadSong('Dub Fx', 'Light Me On Fire', 'You can call me a liar.. ');
    //     assert.equal(myClass.allSongs('Eminem'))
    // });
